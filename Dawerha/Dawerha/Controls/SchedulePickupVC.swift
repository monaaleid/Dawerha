...
class SchedulePickupVC: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    var arrSchedulePickup = [UIImage(named: "days1")!, UIImage(named: "days2")!, UIImage(named: "days3")!, UIImage(named: "days4")!, UIImage(named: "days5")!, UIImage(named: "days7")!, UIImage(named: "days8")!]
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        return CGSize(width: self.view.frame.width / 400, height: self.view.frame.width / 400)
